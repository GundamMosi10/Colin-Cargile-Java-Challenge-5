...
public class GameStoreInvoiceServiceLayerTest {
    ...
    public void setUp() throws Exception {
        ...
        setUpGameStoreClientMock();
        service = new GameStoreInvoiceServiceLayer(invoiceRepository, taxRepository, processingFeeRepository, gameStoreClient );
    }
    ...
    private void setUpGameStoreClientMock() {
        gameStoreClient = mock(GameStoreClient.class);
        ...
        doReturn(tShirt).when(gameStoreClient).createTShirt(tShirt);
        doReturn(tShirt).when(gameStoreClient).getTShirt(54);
